...
.quick-input-widget {
  ...
  border: 1px solid #f2f2f212 !important;
}
...
.suggest-widget {
  ...
  backdrop-filter: blur(10px);
  overflow: hidden;
  box-shadow: 0 0 10px #f2f2f230 !important;
}
...
.monaco-workbench .part.editor .monaco-scrollable-element > .scrollbar.vertical {
  margin-right: 24px;
}
